...
try:
    ...
    RF2D_gc_stix_scatter.argtypes = [ctypes.POINTER(struct_RF2D_gc_stix), ctypes.POINTER(struct_RF_particle_history), ctypes.POINTER(struct_c__SA_particle_simd_gc), ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_ubyte)]
except AttributeError:
    pass
try:
    ...
    RF2D_gc_stix_get_interaction_time.argtypes = [ctypes.POINTER(struct_RF2D_gc_stix), ctypes.POINTER(struct_RF_particle_history), ctypes.c_int32, ctypes.c_int32]
except AttributeError:
    pass
try:
    ...
    pass
try:
    set_rndusage = _libraries['libascot.so'].set_rndusage
    set_rndusage.restype = None
    set_rndusage.argtypes = [ctypes.POINTER(struct_RF2D_gc_stix), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32, uint8]
except AttributeError:
    pass
...
__all__ = \
    ...
    'print_marker_summary', 'real', 'set_rndusage', 'sigma_CX',
    'sigma_ioniz', 'sigma_recomb', 'sigmav_BMS', 'sigmav_CX',
    'sigmav_ioniz', 'sigmav_recomb', 'sigmaveff_CX',
    ...
    'struct_RF2D_fields', 'struct_RF2D_gc_stix', 'struct_RF3D_fields',
    'struct_RF_fields', 'struct_RF_particle_history',
    ...
    'struct_diag_transcoef_link', 'uint8', 'union_RF_fields_0',
